...
<body style="font-family: Times;">
    ...
    <table style="width: 100%; line-height: 25px;">
        ...
        <tr>
            ...
            <td valign="baseline" style="width: 54%;"><?= $surat_masuk[0]->nomor_surat; ?></td>
        ...
        <tr>
            ...
            <td valign="baseline">:</td>
            <td valign="baseline"><?= $surat_masuk[0]->perihal; ?></td>
        </tr>
    </table>
    <br><br>
    ...
    <table style="width: 100%;">
        <tr>
            ...
            <td style="width: 40%; text-align: center;">
                <div style="text-transform:capitalize;"><?= $surat_masuk[0]->nama_bidang; ?></div>
                <br>
                <br>
                <br>
                <br>
                <br>
                <p><u><strong><?= $surat_masuk[0]->nama; ?></strong></u></p>
                <p><?= $surat_masuk[0]->pangkat; ?>, <?= $surat_masuk[0]->golongan; ?></p>
                <p>NIP. <?= $surat_masuk[0]->nip; ?></p>
            </td>
        </tr>
    </table>
</body>
