...
<head>
    ...
    <link rel="stylesheet" id="main-stylesheet" data-version="1.1.0"
        href="<?= base_url(); ?>vendor/dashboard/styles/shards-dashboards.1.1.0.min.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/css/border-left.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/css/animate.css">
    <link rel="stylesheet" type="text/css" href="<?= base_url(); ?>assets/css/bootstrap-material-datetimepicker.css">
    <link rel="stylesheet" href="<?= base_url(); ?>vendor/dashboard/styles/extras.1.1.0.min.css">
